...
const Page = () => {
  return (
    <>
      <Navbar />
      <div className="relative inset-0 min-h-[92vh] md:min-h-[90vh] w-full flex items-center justify-center bg-gradient-to-r from-[#192c16] via-[#216428] to-[#d4cf3e]">
        ...
        <div className="text-center max-w-7xl mx-auto px-2 flex flex-col justify-center h-full relative">
          ...
          <p className='mt-8 md:mt-12 text-lg lg:text-xl text-[#c5c3c3] md:px-10 max-w-5xl mx-auto'>
            This page contains the case study of &apos;Randomly&apos; Open-Source Project which includes the Project Overview, Tools Used, and Live Links to the official product.
          </p>

          <Link href="https://github.com/webd-rupam/Randomly-Chat-NextJs" target="_blank">
            <button
              type="button"
          ...
          <Link href="https://randomlychat.vercel.app" target="_blank">
            <button
              type="button"
      ...
      <div className='min-h-screen w-full overflow-x-hidden flex flex-col justify-center items-center gap-8 md:gap-16 lg:gap-32 pb-16'> 
        ...
        <div className='flex flex-col w-full md:gap-16 mx-auto px-4 md:px-20 lg:px-14 mt-20'>
          <div className='flex flex-col items-center gap-8 md:gap-16 w-full'>
            <img src="randomly.jpg" alt="Project 1 description" className='w-full max-w-[800px] h-auto object-cover' />
            <div className='flex flex-col justify-center w-full xl:w-1/2 text-left lg:ml-10'>
              ...
              Randomly is an engaging chat application designed to connect users with strangers in real time. By leveraging Socket.IO for instant messaging, users are seamlessly matched with others, allowing for spontaneous, anonymous conversations. The application provides a unique, interactive platform where users can communicate without the need for personal information, fostering a sense of mystery and excitement in each chat experience.
              </p>
              
              <p className='text-base md:text-lg mt-7 text-[#666] lg:mr-10 max-w-6xl mx-auto'>
              The standout feature of Randomly is its intuitive matchmaking system. Once connected, users receive real-time updates about their chat status—whether a stranger has joined or left—making it easy to understand the flow of each interaction. With a simple and visually appealing interface, users can enjoy an effortless experience, whether sending messages, seeing when a stranger is connected, or finding someone new to chat with when a conversation ends.
              </p>
              
              <p className='text-base md:text-lg mt-7 text-[#666] lg:mr-10 max-w-6xl mx-auto'>
              Developed with a full-stack approach, Randomly showcases a well-rounded application of both frontend and backend technologies. The frontend, built with Next.js and React, ensures a responsive and user-friendly design, while the backend employs Express.js and Socket.IO to handle seamless real-time communication. This project highlights the developer&apos;s skills in implementing WebSockets, managing user state, and creating a cohesive chat experience from the ground up.
              </p>
